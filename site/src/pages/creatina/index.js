...
export default function Creatinatcc(){

return(
    <div className='pagina-creatina'>
    <Cabecalho/>
...
<div className='pr'>
        ...
        <div className='l1'>
            ...
            <div className='produto1'>
               <img  src='/assets/images/crea1.png'  />
        ...
        <div className='l2'>
            ...
            <div className='produto3'>
                <img src='/assets/images/crea2.png'/>
            ...
            <div className='l3'>
                <img src='/assets/images/crea3.png'/>
